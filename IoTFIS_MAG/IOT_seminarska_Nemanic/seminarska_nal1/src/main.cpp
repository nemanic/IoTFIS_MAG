...
const char* ssid = "Nekoime";
const char* password = "mojegeslo";

int portNumber = 8811; // preko porta 8811 se esp32 poveže na strežnik node.js

// port 80 je nastavljen za posredovanje HTML strani
WebServer server(80); // objekt razreda WebServer (HTTP port, 80 port)
                      // vrednost porta 80 je argument konstruktorja

// na portu 81 ustvarimo servis spletnih vtičnikov - WebSocketsServer
WebSocketsServer webSocket = WebSocketsServer(81);

void handle_root() { // zahteva na strežnik ("request")
  server.send(200); // strežnik klientu pošlje kot "response"
...
void handle_NotFound() { // če ne najdemo spletne strani, npr. če vpišemo /abc
